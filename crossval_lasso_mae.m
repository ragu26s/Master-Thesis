function[soln_fucmse,soln_fcmse,total_ucmse,total_cmse,soln_reg,soln_tunein,l_uctime,l_ctime] = crossval_lasso_mae(kfold,A_fold,b_fold,reg,tunein)
...
for i=1:size(seq,1)
    ...
    n_val=size(A_val,1);
    %Operation
    [xc_l,xuc_l,~,~,~,uctime,ctime]=lasso_op_mae(A_train,b_train,reg,tunein);%OPS
