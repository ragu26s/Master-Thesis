function[soln_reg,soln_tuberadius,soln_alphasvr,soln_alphastarsvr,soln_biassvr] = crossval_svrdual_lin(kfold,A_fold,b_fold,reg,tuberadius,ktype,gaussian_par)
...
%         %Operation
         ...
         %svrdual_error(K,A,b,dualalpha,dualalphastar,reg,tuberadius)
%             
         %calculate MSE
