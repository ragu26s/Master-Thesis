function[total_ucmse,soln_ucmse,soln_reg,soln_alphauc,total_cmse,soln_cmse,soln_tunein,soln_alphac,fold_ucmse,fold_cmse,en_uctime,en_ctime] = crossval_en_mae(kfold,A_fold,b_fold,reg,alpha,tunein)
...
for i=1:size(seq,1)
    ...
    %Operation
    [xc_en,xuc_en,~,~,uctime,ctime]=en_op_mae(A_train,b_train,reg,alpha,tunein);%OPS
