function[soln_fucmse,soln_fcmse,total_ucmse,total_cmse,soln_reg,soln_tunein,r_uctime,r_ctime] = crossval_ridge_hub(kfold,A_fold,b_fold,reg,tunein)
...
for i=1:size(seq,1)
    ...
    n_val=size(b_val,1);
    %             %Operation
    [xc_r,xuc_r,~,~,uctime,ctime]=ridge_op_hub(A_train,b_train,reg,tunein);%OPS
